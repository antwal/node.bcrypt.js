...
[![Build status](https://ci.appveyor.com/api/projects/status/github/kelektiv/node.bcrypt.js?branch=master)](https://ci.appveyor.com/project/kelektiv/node-bcrypt-js/branch/master)
